...
class RatingController extends Controller {
    ...
    public function store(){
        ...
        // print_r($this->dataReq()->dislike);
         if(
             !is_null($this->dataReq()->like)&&
             !is_null($this->dataReq()->dislike)&&
             !is_null($this->dataReq()->user_id)&&
             !is_null($this->dataReq()->stor_id)
            ){
                // Get All Data send clint side
                $like = $this->dataReq()->like;
                $dislike = $this->dataReq()->dislike;
                $user_id = $this->dataReq()->user_id;
                $stor_id = $this->dataReq()->stor_id;
